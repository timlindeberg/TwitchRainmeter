...
namespace IrcDotNet
{
    ...
    internal interface IIrcMessageReceiveHandler
    {
        ...
        void HandleMessageReceived(IIrcMessageSource source, IList<IIrcMessageTarget> targets, string text, string tags);
        ...
        void HandleUserNoticeReceived(IIrcMessageSource source, IList<IIrcMessageTarget> targets, string text, string tags);
    }
}