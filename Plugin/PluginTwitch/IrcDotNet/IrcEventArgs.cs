...
namespace IrcDotNet
{
    ...
    {
        /// <inheritdoc />
        public IrcPreviewMessageEventArgs(IIrcMessageSource source, IList<IIrcMessageTarget> targets, string text, string tags,
            Encoding encoding)
            : base(source, targets, text, tags, encoding)
        {
            Handled = false;
        }
    ...
    public class IrcMessageEventArgs : EventArgs
    {
        ...
        public IrcMessageEventArgs(IIrcMessageSource source, IList<IIrcMessageTarget> targets, string text, string tags,
            Encoding encoding)
        {
            if (targets == null)
