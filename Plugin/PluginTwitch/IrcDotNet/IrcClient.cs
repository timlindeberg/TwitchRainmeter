...
namespace IrcDotNet
{
    ...
    public abstract partial class IrcClient : IDisposable
    {
        ...
        protected void WriteMessage(string prefix, string command, params string[] parameters)
        {
            ...
            var message = new IrcMessage(this, null, prefix, command, parameters.ToArray());
        ...
        protected void ParseMessage(string line)
        {
            ...
            /*
             * @badges=;color=;display-name=Euthimo2000;emotes=;id=861c546c-cdfa-424a-bc80-52a4408289c4;mod=0;room-id=71672341;subscriber=0;turbo=0;user-id=90818553;user-type= 
             *  :euthimo2000!euthimo2000@euthimo2000.tmi.twitch.tv PRIVMSG #p4wnyhof :@p4wnyhof some day you have to attach a rope on the chair and pull it, 
             *  then "come back" and say "what happened? chat?" Or maybe make the stream timer freeze, then go reverse
              */
            ...
            if (line[0] == '@')
            {
                ...
                tags = line.Substring(1, firstSpaceIndex - 1);
            ...
            var message = new IrcMessage(this, tags, prefix, command, parameters);
            var messageReceivedEventArgs = new IrcRawMessageEventArgs(message, fullLine);
            OnRawMessageReceived(messageReceivedEventArgs);
            ReadMessage(message, fullLine);
        ...
        public struct IrcMessage
        {
            ...
            /// </param>
            public IrcMessage(IrcClient client, string tags, string prefix, string command, IList<string> parameters)
            {
                Prefix = prefix;
                Command = command;
